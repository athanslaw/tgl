...
public class Success extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView)findViewById(R.id.success_section_1)).setText("Section 1 score = "+score1);
        ...
        if(session.get(SessionManagement.SECTION_2) != null) {
            ...
            ((TextView)findViewById(R.id.success_section_2)).setText("Section 2 score = "+score2);
        ...
        if(session.get(SessionManagement.SECTION_3) != null) {
            ...
            ((TextView)findViewById(R.id.success_section_3)).setText("Section 3 score = "+score3);
            score += Integer.parseInt(score3);
        }


        ((TextView)findViewById(R.id.success_total)).setText("TOTAL SCORE = "+score);
        ...
        try{
            ...
            if (c.moveToFirst()) {
                do{
                    ((TextView)findViewById(R.id.success_ikName)).setText(c.getString(c.getColumnIndex( usersProvider.ikName)));
                    ((TextView)findViewById(R.id.success_interviewer)).setText(c.getString(c.getColumnIndex( usersProvider.interviewer)));
                    ((TextView)findViewById(R.id.success_date)).setText(c.getString(c.getColumnIndex( usersProvider.date)));

                } while (c.moveToNext());

            }
        }catch(Exception e){
            Toast.makeText(getBaseContext(), "View Record  "+e, Toast.LENGTH_LONG).show();}
